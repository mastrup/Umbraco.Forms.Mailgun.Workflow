angular.module("umbraco").controller("UmbracoForms.Mailgun.Workflow.Controller", function ($scope, $http, $routeParams, pickerResource, mailgunTemplatePickerResource) {
    "use strict";
